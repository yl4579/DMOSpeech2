...
from f5_tts.infer.utils_infer import (convert_char_to_pinyin, load_vocoder,
                                      preprocess_ref_audio_text, speed,
                                      target_rms, transcribe)
# Import F5-TTS modules
from f5_tts.model import CFM, DiT, UNetT
from f5_tts.model.modules import MelSpec
from f5_tts.model.utils import (exists, get_tokenizer, lens_to_mask,
...
class DMOInference:
    ...
    def _setup_models(self, student_checkpoint_path):
        ...
        self.model = UniModel(
            model_cls(**model_cfg, text_num_embeds=self.vocab_size, mel_dim=self.n_mel_channels, second_time=self.num_student_step > 1),
            checkpoint_path="",
